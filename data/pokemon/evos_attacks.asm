...
endc
	...
	learnset 18, POISONPOWDER
	learnset 20, STUN_SPORE
	learnset 22, SLEEP_POWDER ; Psybeam → Sleep Powder
	learnset 24, PSYBEAM ; Silver Wind → Psybeam
	learnset 28, SUPERSONIC
	learnset 30, SAFEGUARD
	learnset 34, HYPNOSIS ; Whirlwind → new move
	learnset 36, BUG_BUZZ
	learnset 40, REFLECT ; Rage Powder → RBY TM move
	learnset 42, AGILITY ; Captivate → new move
	learnset 46, HEALINGLIGHT ; Tailwind → new move
	learnset 48, AIR_SLASH
	learnset 52, PSYCHIC_M ; Quiver Dance → TM move
	...
	learnset 19, RAGE
	learnset 22, PURSUIT
	learnset 25, FOCUS_ENERGY
	learnset 28, VENOSHOCK
	learnset 31, FEINT_ATTACK ; Assurance → similar move
	learnset 34, TOXIC_SPIKES
	learnset 37, PIN_MISSILE
	learnset 40, POISON_JAB
	learnset 43, AGILITY
	learnset 46, SWORDS_DANCE ; Endeavor → TM move
	learnset 49, OUTRAGE ; Fell Stinger → LGPE move
