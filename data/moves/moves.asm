...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLE_SLAP,  EFFECT_MULTI_HIT,          15, FAIRY,     95,  10,   0, PHYSICAL
...
endc
	...
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         40, GRASS,     100, 25,   0, PHYSICAL
...
endc
	...
	move POISON_STING, EFFECT_POISON_HIT,         35, POISON,    100, 20,  30, PHYSICAL
	...
	move BITE,         EFFECT_FLINCH_HIT,         35, DARK,      100, 25,  30, PHYSICAL
...
endc
	...
	move GROWTH,       EFFECT_GROWTH,              0, GRASS,     100, 20,   0, STATUS
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         70, GRASS,      95, 25,   0, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move FIRE_SPIN,    EFFECT_TRAP,               60, FIRE,       90, 15,   0, SPECIAL
endc
...
endc
	...
	move CONFUSION,    EFFECT_CONFUSE_HIT,        40, PSYCHIC,   100, 25,  10, SPECIAL
...
endc
	...
	move WATERFALL,    EFFECT_FLINCH_HIT,         75, WATER,     100, 15,  20, PHYSICAL
	...
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          75, BUG,       100, 10,   0, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move FURY_STRIKES, EFFECT_FURY_STRIKES,       15, FIGHTING,   95, 15,   0, PHYSICAL
endc
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  40, GROUND,    100, 15,  30, SPECIAL
if DEF(FAITHFUL)
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,      85, 10,  50, SPECIAL
else
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  75, FIRE,       95, 10,  30, SPECIAL
endc
	...
	move BUG_BITE,     EFFECT_BUG_BITE,           50, BUG,       100, 20,   0, PHYSICAL
...
endc
	...
	move IRON_TAIL,    EFFECT_NORMAL_HIT,        100, STEEL,      90, 10,   0, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move WHIRLPOOL,    EFFECT_TRAP,               60, WATER,      90, 15,   0, SPECIAL
endc
	...
	move DISARM_VOICE, EFFECT_PRIORITY_HIT,       40, FAIRY,     100, 30,   0, SPECIAL
